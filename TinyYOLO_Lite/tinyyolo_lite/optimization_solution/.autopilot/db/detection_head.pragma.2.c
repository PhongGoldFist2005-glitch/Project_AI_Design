...
# 3 "detection_head.c" 2

void detection_head(
    data_t input[12][12][32],
    data_t output[8][8][(2 * (5 + 3))]
){_ssdm_SpecArrayDimSize(input, 12);_ssdm_SpecArrayDimSize(output, 8);
_ssdm_SpecArrayPartition( input, 2, "CYCLIC", 5, "");
_ssdm_SpecArrayPartition( &w_det, 2, "COMPLETE", 0, "");
