...
{_ssdm_SpecArrayDimSize(input, 64);_ssdm_SpecArrayDimSize(output, 62);
_ssdm_SpecArrayPartition( input, 3, "COMPLETE", 0, "");
_ssdm_SpecArrayPartition( &w_conv1, 3, "COMPLETE", 0, "");
