...
set C_modelArgList {
	...
	{ buf_det int 32 regular {array 1024 { 1 1 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "output_r", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "buf_det", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ buf_det_address0 sc_out sc_lv 10 signal 1 } 
	{ buf_det_ce0 sc_out sc_logic 1 signal 1 } 
	{ buf_det_q0 sc_in sc_lv 32 signal 1 } 
	{ buf_det_address1 sc_out sc_lv 10 signal 1 } 
	{ buf_det_ce1 sc_out sc_logic 1 signal 1 } 
	{ buf_det_q1 sc_in sc_lv 32 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buf_det_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "buf_det", "role": "address0" }} , 
 	{ "name": "buf_det_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buf_det", "role": "ce0" }} , 
 	{ "name": "buf_det_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buf_det", "role": "q0" }} , 
 	{ "name": "buf_det_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "buf_det", "role": "address1" }} , 
 	{ "name": "buf_det_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buf_det", "role": "ce1" }} , 
 	{ "name": "buf_det_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buf_det", "role": "q1" }}  ]}
...
set Spec2ImplPortList { 
	...
	buf_det { ap_memory {  { buf_det_address0 mem_address 1 10 }  { buf_det_ce0 mem_ce 1 1 }  { buf_det_q0 mem_dout 0 32 }  { buf_det_address1 MemPortADDR2 1 10 }  { buf_det_ce1 MemPortCE2 1 1 }  { buf_det_q1 MemPortDOUT2 0 32 } } }
}
