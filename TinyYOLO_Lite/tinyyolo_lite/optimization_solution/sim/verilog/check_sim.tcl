...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.tinyyolo_lite.autotvin_image_0.dat"
         "c.tinyyolo_lite.autotvin_image_1.dat"
         "c.tinyyolo_lite.autotvin_image_2.dat"
         "c.tinyyolo_lite.autotvin_output_r.dat"
         "c.tinyyolo_lite.autotvout_output_r.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.tinyyolo_lite.autotvout_output_r.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
