#pragma line 1 "E:/work_station/TinyYOLO_Lite/conv_relu1.c"
#pragma line 1 "E:/work_station/TinyYOLO_Lite/conv_relu1.c" 1
#pragma line 1 "<built-in>" 1
#pragma line 1 "<built-in>" 3
#pragma line 147 "<built-in>" 3
#pragma line 1 "<command line>" 1
#pragma line 1 "<built-in>" 2
#pragma line 1 "E:/work_station/TinyYOLO_Lite/conv_relu1.c" 2
...
#pragma line 2 "E:/work_station/TinyYOLO_Lite/conv_relu1.c" 2
...
#pragma line 3 "E:/work_station/TinyYOLO_Lite/conv_relu1.c" 2
#pragma empty_line
void conv_layer1(
    data_t input [64][64][3],
    data_t output[62][62][8]
...
#pragma empty_line
 int row, col, oc, kr, kc, ic;
    data_t sum;
#pragma empty_line
    LOOP_ROW: for(row = 0; row < 62; row++) {
        LOOP_COL: for (col = 0; col < 62; col++) {
            LOOP_OC: for(oc = 0; oc < 8; oc++) {
#pragma empty_line
                sum = b_conv1[oc];
                LOOP_KR: for(kr = 0; kr < 3; kr++) {
                    LOOP_KC: for (kc = 0; kc < 3; kc++) {
                        LOOP_IC: for(ic = 0; ic < 3; ic++) {
