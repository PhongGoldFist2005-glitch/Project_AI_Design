...
// ==============================================================
#ifndef __tinyyolo_lite_ureIfE__HH__
#define __tinyyolo_lite_ureIfE__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(tinyyolo_lite_ureIfE) {
    ...
    ACMP_urem_seq<ID, 8, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_urem_seq_U;

    SC_CTOR(tinyyolo_lite_ureIfE):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
