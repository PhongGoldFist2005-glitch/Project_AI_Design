...
set C_modelArgList {
	...
	{ buf_conv3 int 31 regular {array 4608 { 1 3 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "output_r", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "buf_conv3", "interface" : "memory", "bitwidth" : 31, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ buf_conv3_address0 sc_out sc_lv 13 signal 1 } 
	{ buf_conv3_ce0 sc_out sc_logic 1 signal 1 } 
	{ buf_conv3_q0 sc_in sc_lv 31 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buf_conv3_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "buf_conv3", "role": "address0" }} , 
 	{ "name": "buf_conv3_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buf_conv3", "role": "ce0" }} , 
 	{ "name": "buf_conv3_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":31, "type": "signal", "bundle":{"name": "buf_conv3", "role": "q0" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.w_det_U", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3672353", "Max" : "3672353"}
	, {"Name" : "Interval", "Min" : "3672353", "Max" : "3672353"}
]}
...
set Spec2ImplPortList { 
	...
	buf_conv3 { ap_memory {  { buf_conv3_address0 mem_address 1 13 }  { buf_conv3_ce0 mem_ce 1 1 }  { buf_conv3_q0 mem_dout 0 31 } } }
}
