...
set C_modelArgList {
	{ input_r int 32 regular {array 12288 { 1 3 } 1 1 }  }
	{ output_r int 31 regular {array 30752 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ output_r_d0 sc_out sc_lv 31 signal 1 } 
}
set NewPortList {[ 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4128581", "Max" : "4128581"}
	, {"Name" : "Interval", "Min" : "4128581", "Max" : "4128581"}
]}
...
set Spec2ImplPortList { 
	...
	output_r { ap_memory {  { output_r_address0 mem_address 1 15 }  { output_r_ce0 mem_ce 1 1 }  { output_r_we0 mem_we 1 1 }  { output_r_d0 mem_din 1 31 } } }
}
