...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename buf_conv1 \
    op interface \
    ports { buf_conv1_address0 { O 15 vector } buf_conv1_ce0 { O 1 bit } buf_conv1_q0 { I 31 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'buf_conv1'"
}
}
