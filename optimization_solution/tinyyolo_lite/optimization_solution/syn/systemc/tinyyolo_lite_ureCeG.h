...
// ==============================================================
#ifndef __tinyyolo_lite_ureCeG__HH__
#define __tinyyolo_lite_ureCeG__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(tinyyolo_lite_ureCeG) {
    ...
    SC_CTOR(tinyyolo_lite_ureCeG):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
